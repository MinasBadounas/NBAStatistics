...
public class UsageRatingPerPosition {
	...
	public static Map<String, Integer> createMapList(ArrayList<Teamstatsbypositionpergame> teamstatsbypositionpergameList,
		...
		for (int i = 0; i < teamstatsbypositionpergameList.size(); i++) {
			if (teamstatsbypositionpergameList.get(i).getTeam1().getTeamid() == team) {
				...
				case 1:
					mapTeamList.put("PG-PG/SG", (int) teamstatsbypositionpergameList.get(i).getUsageratepercentage());
				case 2:
					mapTeamList.put("SG-SG/SF", (int) teamstatsbypositionpergameList.get(i).getUsageratepercentage());
				case 3:
					mapTeamList.put("SF-SF/PF", (int) teamstatsbypositionpergameList.get(i).getUsageratepercentage());
				case 4:
					mapTeamList.put("C-PF", (int) teamstatsbypositionpergameList.get(i).getUsageratepercentage());
				}
			}		
